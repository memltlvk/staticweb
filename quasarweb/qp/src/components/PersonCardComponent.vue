...
export default defineComponent({
  ...
  setup (props) {
    ...
    function onCardResize (size) {
      ...
      console.log('breakpoint meta = ', brkpt.bp);
    ...
    function runUpdateDim(cardWidth) {
      ...
      const cssDescription = [
        { "cssvar":"--normalFontSize","cssclass":"person-card-section","m":0.0252,"c":0.3472 },
        { "cssvar":"--cardTopMargin","cssclass":"person-card-section","m":0.1890,"c":-0.1457 },
        { "cssvar":"--cardBottomMargin","cssclass":"person-card-section","m":0.1890,"c":-0.1457 },
        { "cssvar":"--imageDivWidth","cssclass":"person-image-div","m":0.3150,"c":0.0906 },
        { "cssvar":"--infodivTopMargin","cssclass":"person-info-div","m":0.1890,"c":-1.3457 },
        { "cssvar":"--infodivBottomMargin","cssclass":"person-info-div","m":0.1260,"c":-1.0638 },
        { "cssvar":"--personNameFontSize","cssclass":"person-name","m":0.0378,"c":0.4709 },
        { "cssvar":"--separatorMarginTop","cssclass":"separator","m":0.0252,"c":-0.3528 },
        { "cssvar":"--separatorMarginBottom","cssclass":"separator","m":0.0252,"c":-0.3528 },
        { "cssvar":"--iconFontSize","cssclass":"icon-style","m":0.0378,"c":0.6709 },
        { "cssvar":"--phonedivBottomMargin","cssclass":"phone-div","m":0.0000,"c":0.0000 }

      ]

      cssDescription.forEach(function(cssDescriptionValue) {
        void calcsetDim(cardWidth, cssDescriptionValue.m, cssDescriptionValue.c, cssDescriptionValue.cssclass, cssDescriptionValue.cssvar)
      })
